...
using System.IO;
using System.Linq;
using Flow2Visio.Graphviz;
using Flow2Visio.Visio.Rendering;

namespace Flow2Visio.Cli
{
    internal class Program
    {
        ...
        private static int RunDot2Plain(string[] args)
        {
            if (args.Length < 3)
            {
                ...
                Console.WriteLine("用法: Flow2Visio.Cli dot2plain input.dot output.plain");
                return 1;
            }
        ...
        private static int RunPlain2Visio(string[] args)
        {
            ...
            {
                Console.WriteLine("参数不足。");
                Console.WriteLine("用法: Flow2Visio.Cli plain2visio input.plain output.vsdx [--visible]");
                return 1;
            }
        ...
        private static void PrintUsage()
        {
            ...
            Console.WriteLine("  Flow2Visio.Cli dot2plain samples\\flow.dot samples\\flow.plain");
            Console.WriteLine("  Flow2Visio.Cli plain2visio samples\\flow.plain output\\flow.vsdx");
        }
    }
}
